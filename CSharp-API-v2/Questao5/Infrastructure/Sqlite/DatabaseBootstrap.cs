...
namespace Questao5.Infrastructure.Sqlite
{
    public class DatabaseBootstrap : IDatabaseBootstrap
    {
        ...
        public void Setup()
        {
            ...
            if (!string.IsNullOrEmpty(tableName) && (tableName == "contacorrente" || tableName == "movimento" || tableName == "movimentoTED" || tableName == "idempotencia"))
                return;
            ...
            // TEDOKON
            //connection.Execute("CREATE TABLE movimentoTED ( " +
            //"idmovimento TEXT(37) PRIMARY KEY," +
            //"idcontacorrente INTEGER(10) NOT NULL," +
            //"datamovimento TEXT(25) NOT NULL," +
            //"tipomovimento TEXT(1) NOT NULL," +
